...
"""
recbole_cross_domain.data.crossdomain_dataset
##########################
"""
...
class CrossDomainDataset():
    """:class:`CrossDomainDataset` is based on :class:`~recbole_cross_domain.data.dataset.dataset.Dataset`,
    ...
    def build(self):
        ...
        See :class:`~recbole_cross_domain.config.eval_setting.EvalSetting` for details.
