...
class Config(object):
    ...
    def __init__(self, model=None, dataset=None, config_file_list=None, config_dict=None):
        ...
        dataset = self._check_cross_domain(dataset)
    ...
    def _check_cross_domain(self, dataset):
        if 'source_domain' in self.external_config_dict or 'target_domain' in self.external_config_dict:
            try:
                source_dataset_name = self.external_config_dict['source_domain']['dataset']
                target_dataset_name = self.external_config_dict['target_domain']['dataset']
            except KeyError:
                raise KeyError(
            ...
            self.external_config_dict['dataset'] = {'source_domain': source_dataset_name,
                                                    'target_domain': target_dataset_name}
            return self.external_config_dict['dataset']
        return dataset
    ...
    def _set_default_parameters(self):
        ...
        if isinstance(self.dataset, str):
            ...
            self.final_config_dict['source_domain']['data_path'] = \
                os.path.join(self.final_config_dict['source_domain']['data_path'], self.dataset['source_domain'])
            self.final_config_dict['target_domain']['data_path'] = \
                os.path.join(self.final_config_dict['target_domain']['data_path'], self.dataset['target_domain'])
